...
def test_add_pets_with_valid_data(name='Hames', animal_type='cat', age='3', pet_photo='images/Hames.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Hames', 'cat', '5', 'images/Hames.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='Anfisa', animal_type='cat', age='13'):
...
def test_successful_update_self_pet_info(name='Anfis', animal_type='koshka', age=10):
...
def test_add_photo_at_pet(pet_photo='images/Miron.jpg'):
...
def test_add_pet_negative_age_number(name='Anfisa', animal_type='cat', age='3', pet_photo='images/Hames.jpg'):
    ...
    assert age not in result['age'], 'Питомец добавлен на сайт '


def test_add_pet_with_four_digit_age_number(name='Hames', animal_type='cat', age='1234', pet_photo='images/Hames.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/Hames.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/Hames.jpg'):
    ...
    name = 'Кошка Анфиса Гуляет Много Дома Еда Еда Еда ЕДА ЕДА ЕДА ЕДА'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Hames', age='3', pet_photo='images/Hames.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Hames', animal_type='44564', age='3',
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Hames', age='2', pet_photo='images/Hames.jpg'):
    ...
    animal_type = 'кошка анфиса идет гуляет гуляет идет еда еда еда еда еда еда'
